...
const AddItem = () => {
  ...
  const showVerificationNudge = () => {
    toast.custom(
            ...
            <div className="flex items-start">
              ...
              <div className="ml-4 flex-1">
                ...
                <p className="mt-1 text-sm text-gray-500">
                  ...
                  Verify your WhatsApp to receive direct enquiries instantly.
                </p>
                ...
                <div className="mt-4 flex gap-3">
                  ...
                  <button
                    onClick={() => {
                      toast.dismiss(t.id);
                      navigate("/my-listings"); // Go to Listings (Skip)
                    }}
      ...
      { duration: Infinity }, // Keeps it open until they click
    );
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // 👇 4. LOGIC: Check verification status
      const isWhatsAppVerified = user?.whatsapp?.isVerified;

      if (!isWhatsAppVerified) {
        showVerificationNudge(); // Show the fancy card
      } else {
        toast.success("Item uploaded successfully");
        navigate("/my-listings"); // Standard flow
      }
    } catch (err) {
      toast.error(err.response?.data?.message || "Upload failed");
    } finally {
              ...
              <div className="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                ...
                <div className="sm:col-span-6">
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    You can provide a link to a video showing your item working
                    or its condition .
                  </p>
                </div>
              </div>
